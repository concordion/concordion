...
## Configuration
The extension can also be [configured](MarkdownConfiguration.md "c:run") to output the source HTML that is generated, and to add extensions to the Markdown language.
...
* [How do I configure it to output the HTML or extend the Markdown syntax?](MarkdownConfiguration.md "c:run")